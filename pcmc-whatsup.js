            ...
            <div class="pcmc-widget" id="pcmcWidget">
                ...
                <div class="pcmc-chat" id="pcmcChat">
                    ...
                    <div class="pcmc-footer">
                        <button class="pcmc-action-btn" onclick="window.open('https://wa.me/${config.phoneNumber}?text=${encodeURIComponent(config.defaultMessage)}', '_blank')">
